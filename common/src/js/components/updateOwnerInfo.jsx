...
export default class UpdateOwnerInfo extends Component {
    ...
    handleSubmit(event) {
        ...
        const { dispatch, name, email, password, phone_number } = this.props;
        dispatch(updateOwnerInfo( name, email, password, phone_number ));
    }


    render() {
        const { name, email, password, phone_number} = this.props;
