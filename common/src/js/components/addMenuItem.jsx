                        ...
                        <div className="card " style={{ marginTop: '80px' }}>
                            <form action="">
                                <div className="card-body form-group">
                                    ...
                                    <input type="text" name='name' placeholder='Enter item name...' className='form-control' />
                                    <br />
                                    <label htmlFor="price"><strong>Price   </strong></label>
                                    <input type="text" name='price' placeholder='Enter price...' className="form-control" />
                                    <br />
                                    ...
                                    <select className="form-control" name="itemType" id="item-type">
                                ...
                                <div className="card-footer text-muted">
                                    <a href="/"><button className="btn btn-primary form-control">Enter</button></a>
                                </div>
                            </form>
                        </div>
                    </div>
