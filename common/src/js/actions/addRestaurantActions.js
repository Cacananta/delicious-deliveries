...
export function addNewRestaurant(food_type, name, address1, address2, city, state, zip, image, phone_number) {
    console.log(food_type, name, address1, address2, city, state, zip, image, phone_number);
    return {
        type: types.ADD_NEW_RESTAURANT,
        payload: axios.post('http://localhost:3000/api/Restaurants', {food_type, name, address1, address2, city, state, zip, image, phone_number})
